...
namespace LawtechPTSystemByFirm.US
{
    public partial class TrademarkNotifyFinish : Form
    {
        ...
        private void TrademarkNotifyFinish_Load(object sender, EventArgs e)
        {
            ...
            {
                Public.CTrademarkControversyNotifyEvent notify = new LawtechPTSystemByFirm.Public.CTrademarkControversyNotifyEvent("TMNotifyControversyEventID=" + NotifyEventID.ToString());
