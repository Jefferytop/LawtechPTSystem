...
namespace LawtechPTSystemByFirm.US
{
    ...
    public partial class PatentComitEventFinish : Form
    {
        ...
        private void PatentComitEventFinish_Load(object sender, EventArgs e)
        {
            ...
            Public.CPatComitEvent comitEvent = new LawtechPTSystemByFirm.Public.CPatComitEvent();
            ...
            txt_Result.Text = maskedTextBox_ComitDate.Text + "已送件";                 

            List<Public.CPatComitContent> content = new List<LawtechPTSystemByFirm.Public.CPatComitContent>();
            Public.CPatComitContent.ReadList(ref content ,"ComitContent='" + comitEvent.EventContent.Trim() + "'" );
            ...
            if (content.Count>0 && content[0].ComitContentID != -1)
            {
                comboBox_status.SelectedValue = content[0].Status;
            }
            else
            {
            ...
            txt_statusExplain.Text = maskedTextBox_ComitDate.Text + txt_EventContent.Text + " 送件";
