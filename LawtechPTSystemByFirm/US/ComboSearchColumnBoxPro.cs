...
namespace LawtechPTSystemByFirm.US
{
    ...
    /// 
    /// </summary>
     public partial class ComboSearchColumnBoxPro : UserControl
    {
        ...
        public ComboSearchColumnBoxPro()
        {
            InitializeComponent();
        ...
        public string SQLSelectedValueColumn
        {
            get
            {
                ...
                switch (ComboxItem.DropDwonMode)
                {
                    case 1:
                    case 0:
                        sWhere = string.Format("{2} {0} Like '{1}' ", ComboxItem.ValueString, cbSelectedValue.Text.Trim()+"%",rab_or.Checked? " or ":" and " );
                        break;
                    case 2:
                        sWhere = string.Format("{2} {0} ={1} ", ComboxItem.ValueString, cbSelectedValue.SelectedValue.ToString(), rab_or.Checked ? " or " : " and ");
                        break;
                    case 3:
                        sWhere = string.Format("{2} {0} ='{1}' ", ComboxItem.ValueString, cbSelectedValue.SelectedValue.ToString(), rab_or.Checked ? " or " : " and ");
                        break;
            ...
            if (!string.IsNullOrEmpty(SearchType))
            {
                ...
                switch (ComboxItem.DropDwonMode)
                {
                    ...
                    case 1:
                        ...
                        cbSelectedValue.AutoCompleteMode = AutoCompleteMode.SuggestAppend;
