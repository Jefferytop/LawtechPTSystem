                    ...
                    { 
                        ...
                        case 2:
                            for (int iRow = 0; iRow < GV.SelectedRows.Count; iRow++)
                            {
                                ...
                                Public.CTrademarkManagement Trademark = new LawtechPTSystemByFirm.Public.CTrademarkManagement();
                        ...
                        case 3:
                            ...
                            {
                                int TrademarkID = (int)GV.SelectedRows[iRow].Cells["TrademarkID"].Value;
                                Public.CTrademarkControversyManagement Trademark = new LawtechPTSystemByFirm.Public.CTrademarkControversyManagement();
