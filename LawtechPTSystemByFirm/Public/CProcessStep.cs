...
namespace LawtechPTSystemByFirm.Public
{
    ...
    /// 
    /// </summary>
    [TableMapping("ProcessStepET")]
    public class CProcessStep : SysBaseModel
    {
        ...
        public object CheckValueExist(string ColumnName, object Value, ref bool IsExist, bool IsCreateMode = true)
        {
            ...
            List<CProcessStep> list = new List<CProcessStep>();
            ...
            if (IsCreateMode)
            {
                retObj = orm.ReadListToObjs<CProcessStep>(ColumnName + "=@" + ColumnName, ref list, ParList);
            }
            else
            {
                retObj = orm.ReadListToObjs<CProcessStep>(ColumnName + "=@" + ColumnName + " and ProcessHandleKEY<>" + this.ProcessHandleKEY.ToString(), ref list, ParList);
            }
        ...
        #region 取得一筆資料  ReadOne(ref CProcessStep Item, string strCusTableName = ")
        /// <summary>
        /// 取得一筆ProcessStepET資料
        /// </summary>          
        ...
        /// <returns>0:成功 ; string:失敗</returns>       
        public static object ReadOne(ref CProcessStep Item, string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        /// <returns>0:成功 ; string:失敗</returns>       
        public static object ReadOne(int iPKey, ref CProcessStep item, string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
        ...
        #region 取得一筆ProcessStepET資料 ReadOne(string strSqlWhere, System.Data.SqlClient.SqlParameter[] MySqlParameterList=null, string strCusTableName = "")
        /// <summary>
        /// 取得一筆ProcessStepET資料;如果有多筆符合條件，則只回傳null
        /// </summary>
        /// <param name="strSqlWhere">查詢條件(不用加「where」關鍵字, 可加Sql參數,例如: account=@account)</param>
        /// <param name="MySqlParameterList">Sql參數</param>
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        /// <returns>0:成功 ; string:失敗</returns>
        public static object ReadOne(string strSqlWhere, ref CProcessStep item, System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
            List<CProcessStep> itemlist = new List<CProcessStep>();
        ...
        #region 取得多筆CProcessStep資料 ReadList
        /// <summary>
        /// 取得多筆 ProcessStepET資料 
        /// </summary>
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>      
        /// <returns></returns>
        public static object ReadList(ref List<CProcessStep> Items, string strSqlWhere = "", System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strOrderBy = "", string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();

            object retObj = orm.ReadListToObjs<CProcessStep>(strSqlWhere, ref Items, sqlParameterList: MySqlParameterList, OrderBy: strOrderBy, CusTableName: strCusTableName);
        ...
        #region 取得多筆 ProcessStepET資料 , 指定頁數和頁碼 ReadList
        /// <summary>
        /// 取得多筆 ProcessStepET資料 , 指定頁數和頁碼
        /// </summary>
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>       
        /// <returns></returns>
        public static object ReadList(int PageSize, int PageIndex, ref List<CProcessStep> Items, string strSqlWhere = "", System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strOrderBy = "", string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();

            object retObj = orm.ReadListToObjs<CProcessStep>(PageSize, PageIndex, strSqlWhere, ref Items, sqlParameterList: MySqlParameterList, OrderBy: strOrderBy, CusTableName: strCusTableName);
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.InsertByObj<CProcessStep>(this, strCusTableName);
            return retObj;
        }
        #endregion
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.UpdateObj<CProcessStep>(this, strCusTableName);
            return retObj;
        }
        #endregion
        ...
        #region 刪除項目ProcessStepET Delete()
        /// <summary>
        /// 刪除項目ProcessStepET
        /// </summary>  
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.DeleteObj<CProcessStep>(this, strCusTableName);
            return retObj;
        }
        #endregion

        #region 刪除項目ProcessStepET Delete(int iPKey)
        /// <summary>
        /// 刪除項目ProcessStepET , 指定某一筆主鍵刪除(單筆)
        /// </summary>
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.DeleteObj<CProcessStep>(iPKey, strCusTableName);
            return retObj;
        }
        #endregion

        #region 刪除項目ProcessStepET Delete(string strSqlWhere)
        /// <summary>
        /// 刪除項目ProcessStepET ,符合條件刪除(多筆)
        /// </summary>
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.DeleteObj<CProcessStep>(strSqlWhere, strCusTableName);
            return retObj;
        }
        #endregion
