...
{
    #region CTrademarkEstimateCost=================
    /// <summary>
    /// 
    /// </summary>
    [TableMapping("TrademarkEstimateCostT")]
    public class CTrademarkEstimateCost : SysBaseModel
    {
        #region Public property

        private int m_TMEstimateCostID;
        /// <summary>
        /// 預估成本資料表 PK
        /// </summary>
        [TableColumnSetting("TMEstimateCostID", DbType = SqlDataType.Int, IsPrimary = true, IsCumulative = true, IsCanNull = false, DataLength = 4)]
        public int TMEstimateCostID
        {
            get
            {
                return m_TMEstimateCostID;
            }
            set
            {
                m_TMEstimateCostID = value;
            }
        }
        ...
        /// 
        /// </summary>
        [TableColumnSetting("OMoney", DataLength = 100)]
        ...
        /// 預估報價
        /// </summary>
        [TableColumnSetting("ServicePrice", DbType = SqlDataType.Decimal, DataLength = 9)]
        ...
        public object CheckValueExist(string ColumnName, object Value, ref bool IsExist, bool IsCreateMode = true)
        {
            ...
            List<CTrademarkEstimateCost> list = new List<CTrademarkEstimateCost>();
            ...
            if (IsCreateMode)
            {
                retObj = orm.ReadListToObjs<CTrademarkEstimateCost>(ColumnName + "=@" + ColumnName, ref list, ParList);
            }
            else
            {
                retObj = orm.ReadListToObjs<CTrademarkEstimateCost>(ColumnName + "=@" + ColumnName + " and TMEstimateCostID<>" + this.TMEstimateCostID.ToString(), ref list, ParList);
            }
        ...
        #region 取得一筆資料  ReadOne(ref CTrademarkEstimateCost Item, string strCusTableName = ")
        /// <summary>
        /// 取得一筆TrademarkEstimateCostT資料
        /// </summary>          
        /// <param name="item"></param>   
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        /// <returns>0:成功 ; string:失敗</returns>       
        public static object ReadOne(ref CTrademarkEstimateCost Item, string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
        ...
        #region 取得一筆資料 ReadOne(int iPKey, ref CTrademarkEstimateCost item, string strCusTableName = "")
        /// <summary>
        /// 取得一筆TrademarkEstimateCostT資料
        /// </summary>
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        /// <returns>0:成功 ; string:失敗</returns>       
        public static object ReadOne(int iPKey, ref CTrademarkEstimateCost item, string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
        ...
        #region 取得一筆TrademarkEstimateCostT資料 ReadOne(string strSqlWhere, System.Data.SqlClient.SqlParameter[] MySqlParameterList=null, string strCusTableName = "")
        /// <summary>
        /// 取得一筆TrademarkEstimateCostT資料;如果有多筆符合條件，則只回傳null
        /// </summary>
        /// <param name="strSqlWhere">查詢條件(不用加「where」關鍵字, 可加Sql參數,例如: account=@account)</param>
        /// <param name="MySqlParameterList">Sql參數</param>
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        /// <returns>0:成功 ; string:失敗</returns>
        public static object ReadOne(string strSqlWhere, ref CTrademarkEstimateCost item, System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
            List<CTrademarkEstimateCost> itemlist = new List<CTrademarkEstimateCost>();
        ...
        #region 取得多筆CTrademarkEstimateCost資料 ReadList
        /// <summary>
        /// 取得多筆 TrademarkEstimateCostT資料 
        /// </summary>
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>      
        /// <returns></returns>
        public static object ReadList(ref List<CTrademarkEstimateCost> Items, string strSqlWhere = "", System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strOrderBy = "", string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();

            object retObj = orm.ReadListToObjs<CTrademarkEstimateCost>(strSqlWhere, ref Items, sqlParameterList: MySqlParameterList, OrderBy: strOrderBy, CusTableName: strCusTableName);
        ...
        #region 取得多筆 TrademarkEstimateCostT資料 , 指定頁數和頁碼 ReadList
        /// <summary>
        /// 取得多筆 TrademarkEstimateCostT資料 , 指定頁數和頁碼
        /// </summary>
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>       
        /// <returns></returns>
        public static object ReadList(int PageSize, int PageIndex, ref List<CTrademarkEstimateCost> Items, string strSqlWhere = "", System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strOrderBy = "", string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();

            object retObj = orm.ReadListToObjs<CTrademarkEstimateCost>(PageSize, PageIndex, strSqlWhere, ref Items, sqlParameterList: MySqlParameterList, OrderBy: strOrderBy, CusTableName: strCusTableName);
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.InsertByObj<CTrademarkEstimateCost>(this, strCusTableName);
            return retObj;
        }
        #endregion
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.UpdateObj<CTrademarkEstimateCost>(this, strCusTableName);
            return retObj;
        }
        #endregion
        ...
        #region 刪除項目TrademarkEstimateCostT Delete()
        /// <summary>
        /// 刪除項目TrademarkEstimateCostT
        /// </summary>  
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        /// <returns></returns>   
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.DeleteObj<CTrademarkEstimateCost>(this, strCusTableName);
            return retObj;
        }
        #endregion

        #region 刪除項目TrademarkEstimateCostT Delete(int iPKey)
        /// <summary>
        /// 刪除項目TrademarkEstimateCostT , 指定某一筆主鍵刪除(單筆)
        /// </summary>
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.DeleteObj<CTrademarkEstimateCost>(iPKey, strCusTableName);
            return retObj;
        }
        #endregion

        #region 刪除項目TrademarkEstimateCostT Delete(string strSqlWhere)
        /// <summary>
        /// 刪除項目TrademarkEstimateCostT ,符合條件刪除(多筆)
        /// </summary>
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.DeleteObj<CTrademarkEstimateCost>(strSqlWhere, strCusTableName);
            return retObj;
        }
        #endregion
