...
{
    #region CTrademarkWorkReport=================
    /// <summary>
    /// 
    /// </summary>
    [TableMapping("TrademarkWorkReportT")]
    public class CTrademarkWorkReport : SysBaseModel
    {
        ...
        /// <summary>
        /// 觸發事件ID(TrademarkProcessStepET PK)
        /// </summary>
        ...
        public object CheckValueExist(string ColumnName, object Value, ref bool IsExist, bool IsCreateMode = true)
        {
            ...
            List<CTrademarkWorkReport> list = new List<CTrademarkWorkReport>();
            ...
            if (IsCreateMode)
            {
                retObj = orm.ReadListToObjs<CTrademarkWorkReport>(ColumnName + "=@" + ColumnName, ref list, ParList);
            }
            else
            {
                retObj = orm.ReadListToObjs<CTrademarkWorkReport>(ColumnName + "=@" + ColumnName + " and WorkReportID<>" + this.WorkReportID.ToString(), ref list, ParList);
            }
        ...
        #region 取得一筆資料  ReadOne(ref CTrademarkWorkReport Item, string strCusTableName = ")
        /// <summary>
        /// 取得一筆TrademarkWorkReportT資料
        /// </summary>          
        /// <param name="item"></param>   
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        /// <returns>0:成功 ; string:失敗</returns>       
        public static object ReadOne(ref CTrademarkWorkReport Item, string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
        ...
        #region 取得一筆資料 ReadOne(int iPKey, ref CTrademarkWorkReport item, string strCusTableName = "")
        /// <summary>
        /// 取得一筆TrademarkWorkReportT資料
        /// </summary>
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        /// <returns>0:成功 ; string:失敗</returns>       
        public static object ReadOne(int iPKey, ref CTrademarkWorkReport item, string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
        ...
        #region 取得一筆TrademarkWorkReportT資料 ReadOne(string strSqlWhere, System.Data.SqlClient.SqlParameter[] MySqlParameterList=null, string strCusTableName = "")
        /// <summary>
        /// 取得一筆TrademarkWorkReportT資料;如果有多筆符合條件，則只回傳null
        /// </summary>
        /// <param name="strSqlWhere">查詢條件(不用加「where」關鍵字, 可加Sql參數,例如: account=@account)</param>
        /// <param name="MySqlParameterList">Sql參數</param>
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        /// <returns>0:成功 ; string:失敗</returns>
        public static object ReadOne(string strSqlWhere, ref CTrademarkWorkReport item, System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
            List<CTrademarkWorkReport> itemlist = new List<CTrademarkWorkReport>();
        ...
        #region 取得多筆CTrademarkWorkReport資料 ReadList
        /// <summary>
        /// 取得多筆 TrademarkWorkReportT資料 
        /// </summary>
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>      
        /// <returns></returns>
        public static object ReadList(ref List<CTrademarkWorkReport> Items, string strSqlWhere = "", System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strOrderBy = "", string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();

            object retObj = orm.ReadListToObjs<CTrademarkWorkReport>(strSqlWhere, ref Items, sqlParameterList: MySqlParameterList, OrderBy: strOrderBy, CusTableName: strCusTableName);
        ...
        #region 取得多筆 TrademarkWorkReportT資料 , 指定頁數和頁碼 ReadList
        /// <summary>
        /// 取得多筆 TrademarkWorkReportT資料 , 指定頁數和頁碼
        /// </summary>
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>       
        /// <returns></returns>
        public static object ReadList(int PageSize, int PageIndex, ref List<CTrademarkWorkReport> Items, string strSqlWhere = "", System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strOrderBy = "", string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();

            object retObj = orm.ReadListToObjs<CTrademarkWorkReport>(PageSize, PageIndex, strSqlWhere, ref Items, sqlParameterList: MySqlParameterList, OrderBy: strOrderBy, CusTableName: strCusTableName);
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.InsertByObj<CTrademarkWorkReport>(this, strCusTableName);
            return retObj;
        }
        #endregion
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.UpdateObj<CTrademarkWorkReport>(this, strCusTableName);
            return retObj;
        }
        #endregion
        ...
        #region 刪除項目TrademarkWorkReportT Delete()
        /// <summary>
        /// 刪除項目TrademarkWorkReportT
        /// </summary>  
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        /// <returns></returns>   
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.DeleteObj<CTrademarkWorkReport>(this, strCusTableName);
            return retObj;
        }
        #endregion

        #region 刪除項目TrademarkWorkReportT Delete(int iPKey)
        /// <summary>
        /// 刪除項目TrademarkWorkReportT , 指定某一筆主鍵刪除(單筆)
        /// </summary>
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.DeleteObj<CTrademarkWorkReport>(iPKey, strCusTableName);
            return retObj;
        }
        #endregion

        #region 刪除項目TrademarkWorkReportT Delete(string strSqlWhere)
        /// <summary>
        /// 刪除項目TrademarkWorkReportT ,符合條件刪除(多筆)
        /// </summary>
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.DeleteObj<CTrademarkWorkReport>(strSqlWhere, strCusTableName);
            return retObj;
        }
        #endregion
