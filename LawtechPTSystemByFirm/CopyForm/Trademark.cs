        ...
        private void but_OK_Click(object sender, EventArgs e)
        {
            ...
            if (txt_NewPicture.Text != "")
            {
                ...
                if (File.Exists(txt_NewPicture.Text))
                {
                   ...
                   // Public.CUpLoadFile upfile = new LawtechPTSystemByFirm.Public.CUpLoadFile(string.Format("MainParentID={0} and FileKind=4 and FileType=6 ", AddCTrademarkManagement.TrademarkID));
