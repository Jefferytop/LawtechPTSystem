...
namespace LawtechPTSystemByFirm.QS_DataSet_ControlEventTableAdapters {
...
SELECT WorkReportID, EventType, EventID, Worker, WorkContent, WorkDate, StartTime, EndTime, AllTime, Progress, IsStart, iTime, OstatusSN, EstimateDateTime, Memo FROM PatWorkReportT WHERE (WorkReportID = SCOPE_IDENTITY())";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"
                      SELECT         PatWorkReportT.WorkReportID, PatWorkReportT.EventType,
                      PatWorkReportT.EventID, PatWorkReportT.Worker,
                      PatWorkReportT.WorkContent, PatWorkReportT.WorkDate,
                      PatWorkReportT.StartTime, PatWorkReportT.EndTime, PatWorkReportT.AllTime,
                      PatWorkReportT.Progress, PatWorkReportT.IsStart, PatWorkReportT.iTime,
                      PatWorkReportT.OstatusSN, PatWorkReportT.EstimateDateTime,
                      PatWorkReportT.Memo, WorkerT.EmployeeName AS WorkerName
                      FROM             PatWorkReportT LEFT OUTER JOIN
                      WorkerT ON PatWorkReportT.Worker = WorkerT.WorkerKey
                      WHERE         (PatWorkReportT.EventType = @EventType) AND
                      (PatWorkReportT.EventID = @EventID)";
