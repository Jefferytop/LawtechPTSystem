...
namespace LawtechPTSystemByFirm.AddFrom
{
    public partial class AddCustQuotationNew : Form
    {
        ...
        private void AddCustQuotationNew_Load(object sender, EventArgs e)
        {
            ...
            object obj=dll.QueryToDataTableByDataAdapter(string.Format(SQLCommand, _country, _kind, (_largeentity == true) ? "1" : "0"),ref TriffDT);
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            ccf.Attorney = TriffDT.Rows[bsTriff.Position]["Attorney"].ToString();
            ccf.AttorneyFeeNT = Utility.isNumeric(txtAttorneyFeeNT.Text, "decimal") ? decimal.Parse(txtAttorneyFeeNT.Text) : 0;
            ccf.AttorneyGovFee = decimal.Parse(TriffDT.Rows[bsTriff.Position]["AttorneyGovFee"].ToString());
