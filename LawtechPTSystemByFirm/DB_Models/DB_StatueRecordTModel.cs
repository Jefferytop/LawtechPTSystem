...
{
    #region DB_StatueRecordTModel=================
    /// <summary>
    /// 
    /// </summary>
    [TableMapping("StatueRecordT")]
    public class DB_StatueRecordTModel : SysBaseModel
    {
        ...
        /// 
        /// </summary>
        [TableColumnSetting("Value", DataLength = 3000)]
        public string Value
        {
            get
            {
        ...
        public object CheckValueExist(string ColumnName, object Value, ref bool IsExist, bool IsCreateMode = true)
        {
            ...
            List<DB_StatueRecordTModel> list = new List<DB_StatueRecordTModel>();
            ...
            if (IsCreateMode)
            {
                retObj = orm.ReadListToObjs<DB_StatueRecordTModel>(ColumnName + "=@" + ColumnName, ref list, ParList);
            }
            else
            {
                retObj = orm.ReadListToObjs<DB_StatueRecordTModel>(ColumnName + "=@" + ColumnName + " and SRID<>" + this.SRID.ToString(), ref list, ParList);
            }
        ...
        #region 取得一筆資料  ReadOne(ref DB_StatueRecordTModel Item, string strCusTableName = ")
        /// <summary>
        /// 取得一筆StatueRecordT資料
        /// </summary>          
        ...
        /// <returns>0:成功 ; string:失敗</returns>       
        public static object ReadOne(ref DB_StatueRecordTModel Item, string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        /// <returns>0:成功 ; string:失敗</returns>       
        public static object ReadOne(int iPKey, ref DB_StatueRecordTModel item, string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        /// <returns>0:成功 ; string:失敗</returns>
        public static object ReadOne(string strSqlWhere, ref DB_StatueRecordTModel item, System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
            List<DB_StatueRecordTModel> itemlist = new List<DB_StatueRecordTModel>();
        ...
        #region 取得多筆DB_StatueRecordTModel資料 ReadList
        /// <summary>
        /// 取得多筆 StatueRecordT資料 
        /// </summary>
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>      
        /// <returns></returns>
        public static object ReadList(ref List<DB_StatueRecordTModel> Items, string strSqlWhere = "", System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strOrderBy = "", string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();

            object retObj = orm.ReadListToObjs<DB_StatueRecordTModel>(strSqlWhere, ref Items, sqlParameterList: MySqlParameterList, OrderBy: strOrderBy, CusTableName: strCusTableName);
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>       
        /// <returns></returns>
        public static object ReadList(int PageSize, int PageIndex, ref List<DB_StatueRecordTModel> Items, string strSqlWhere = "", System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strOrderBy = "", string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();

            object retObj = orm.ReadListToObjs<DB_StatueRecordTModel>(PageSize, PageIndex, strSqlWhere, ref Items, sqlParameterList: MySqlParameterList, OrderBy: strOrderBy, CusTableName: strCusTableName);
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.InsertByObj<DB_StatueRecordTModel>(this, strCusTableName);
            return retObj;
        }
        #endregion
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.UpdateObj<DB_StatueRecordTModel>(this, strCusTableName);
            return retObj;
        }
        #endregion
        ...
        #region 刪除項目StatueRecordT Delete()
        /// <summary>
        /// 刪除項目StatueRecordT
        /// </summary>  
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.DeleteObj<DB_StatueRecordTModel>(this, strCusTableName);
            return retObj;
        }
        #endregion

        #region 刪除項目StatueRecordT Delete(int iPKey)
        /// <summary>
        /// 刪除項目StatueRecordT , 指定某一筆主鍵刪除(單筆)
        /// </summary>
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.DeleteObj<DB_StatueRecordTModel>(iPKey, strCusTableName);
            return retObj;
        }
        #endregion

        #region 刪除項目StatueRecordT Delete(string strSqlWhere)
        /// <summary>
        /// 刪除項目StatueRecordT ,符合條件刪除(多筆)
        /// </summary>
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.DeleteObj<DB_StatueRecordTModel>(strSqlWhere, strCusTableName);
            return retObj;
        }
        #endregion
