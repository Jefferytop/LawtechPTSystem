...
namespace LawtechPTSystemByFirm.DB_Models
{
    #region DB_GridColumnTModel=================
    /// <summary>
    /// DataGrid設定表
    /// </summary>
    [TableMapping("GridColumnT")]
    public class DB_GridColumnTModel : SysBaseModel
    {
        ...
        public object CheckValueExist(string ColumnName, object Value, ref bool IsExist, bool IsCreateMode = true)
        {
            ...
            List<DB_GridColumnTModel> list = new List<DB_GridColumnTModel>();
            ...
            if (IsCreateMode)
            {
                retObj = orm.ReadListToObjs<DB_GridColumnTModel>(ColumnName + "=@" + ColumnName, ref list, ParList);
            }
            else
            {
                retObj = orm.ReadListToObjs<DB_GridColumnTModel>(ColumnName + "=@" + ColumnName + " and GridColumnKey<>" + this.GridColumnKey.ToString(), ref list, ParList);
            }
        ...
        #region 取得一筆資料  ReadOne(ref DB_GridColumnTModel Item, string strCusTableName = ")
        /// <summary>
        /// 取得一筆GridColumnT資料
        /// </summary>          
        ...
        /// <returns>0:成功 ; string:失敗</returns>       
        public static object ReadOne(ref DB_GridColumnTModel Item, string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        /// <returns>0:成功 ; string:失敗</returns>       
        public static object ReadOne(int iPKey, ref DB_GridColumnTModel item, string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        /// <returns>0:成功 ; string:失敗</returns>
        public static object ReadOne(string strSqlWhere, ref DB_GridColumnTModel item, System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
            List<DB_GridColumnTModel> itemlist = new List<DB_GridColumnTModel>();
        ...
        #region 取得多筆DB_GridColumnTModel資料 ReadList
        /// <summary>
        /// 取得多筆 GridColumnT資料 
        /// </summary>
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>      
        /// <returns></returns>
        public static object ReadList(ref List<DB_GridColumnTModel> Items, string strSqlWhere = "", System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strOrderBy = "", string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();

            object retObj = orm.ReadListToObjs<DB_GridColumnTModel>(strSqlWhere, ref Items, sqlParameterList: MySqlParameterList, OrderBy: strOrderBy, CusTableName: strCusTableName);
        ...
        /// </summary>
        /// <param name="Items"></param>
        /// <param name="GridSymboID">Grid代碼</param>       
        /// <returns></returns>
        public static object ReadList(ref List<DB_GridColumnTModel> Items, string GridSymboID )
        {
            string SqlWhere = "GridSymboID=@GridSymboID";
            SqlParameter[] SqlParameterList = { DBAccess.MakeInParam("GridSymboID", SqlDataType.VarChar, GridSymboID) };
            string OrderBy="Sort";
            object retObj = ReadList(ref Items, strSqlWhere:SqlWhere, MySqlParameterList: SqlParameterList, strOrderBy: OrderBy);
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>       
        /// <returns></returns>
        public static object ReadList(int PageSize, int PageIndex, ref List<DB_GridColumnTModel> Items, string strSqlWhere = "", System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strOrderBy = "", string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();

            object retObj = orm.ReadListToObjs<DB_GridColumnTModel>(PageSize, PageIndex, strSqlWhere, ref Items, sqlParameterList: MySqlParameterList, OrderBy: strOrderBy, CusTableName: strCusTableName);
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.InsertByObj<DB_GridColumnTModel>(this, strCusTableName);
            return retObj;
        }
        #endregion
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.UpdateObj<DB_GridColumnTModel>(this, strCusTableName);
            return retObj;
        }
        #endregion
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.DeleteObj<DB_GridColumnTModel>(this, strCusTableName);
            return retObj;
        }
        #endregion
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.DeleteObj<DB_GridColumnTModel>(iPKey, strCusTableName);
            return retObj;
        }
        #endregion
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.DeleteObj<DB_GridColumnTModel>(strSqlWhere, strCusTableName);
            return retObj;
        }
        #endregion
