                    ...
                    for (int iRow = 0; iRow < dtHistory.Rows.Count; iRow++)
                    {
                        ...
                        switch (dtHistory.Rows[iRow]["EventType"].ToString())
                        {
                            case "1":
                                ...
                                Public.CPatComitEvent comit = new LawtechPTSystemByFirm.Public.CPatComitEvent();
                                ...
                                break;
                            case "2":
                                Public.CPatNotifyEvent Notify = new LawtechPTSystemByFirm.Public.CPatNotifyEvent("PatNotifyEventID=" + dtHistory.Rows[iRow]["EventID"].ToString());
                            ...
                            case "3":
                                ...
                                break;
                            case "4":
                                Public.CPatentPayment PatentPayment = new LawtechPTSystemByFirm.Public.CPatentPayment();
