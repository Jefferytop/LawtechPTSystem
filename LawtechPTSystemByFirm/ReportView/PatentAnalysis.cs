...
namespace LawtechPTSystemByFirm.ReportView
{
    public partial class PatentAnalysis : Form
    {
        ...
        private void PatentAnalysis_Load(object sender, EventArgs e)
        {
            ...
            {
                case 1:                    
                    reportViewer1.LocalReport.ReportEmbeddedResource = "LawtechPTSystemByFirm.Report.PatentCount.rdlc";                    
                ...
                case 5:
                    ...
                    break;
                case 6:
                    reportViewer1.LocalReport.ReportEmbeddedResource = "LawtechPTSystemByFirm.Report.PatentStatus_Analysis.rdlc";
