    ...
    public partial class TrademarkHistoryRecord : Form
    {
        ...
        public string property_TMrootPath
        {
            get
            {
                ...
                return dll.TrademarkFolderRoot;
            }
        }
        ...
        {
            if (this.dataSet_TM.TrademarkManagementT.Rows[0]["PicPath"].ToString() != "")
            {
                try
                {
                    string sPath = property_TMrootPath + "\\" + this.dataSet_TM.TrademarkManagementT.Rows[0]["PicPath"].ToString();
