            ...
            if (dgViewMF.CurrentRow != null)
            {
                ...
                switch (e.ClickedItem.Name)
                {
                    case "ToolStripMenuItem_FinishFee":
                        ...
                        US.AccountingPaymentFinish fee = new LawtechPTSystemByFirm.US.AccountingPaymentFinish();
                    ...
                    case "ToolStripMenuItem_SingOff":
                        ...
                        if (sCaseType == "Pat")
                        {
                            EditForm.EditPatentPayment patentfee = new LawtechPTSystemByFirm.EditForm.EditPatentPayment();
                        ...
                        {
                            EditForm.EditTrademarkPayment trademarkfee = new LawtechPTSystemByFirm.EditForm.EditTrademarkPayment();
                    ...
                    case "ToolStripMenuItem_PatentCompleteHistory":
                        ...
                        {
                            ViewFrom.TrademarkControversyCompleteHistory history = new LawtechPTSystemByFirm.ViewFrom.TrademarkControversyCompleteHistory();
                            history.Gv = dgViewMF;
                            history.Show();
                        }
                        break;
                    ...
                    case "toolStripMenuItem_CloseAccount"://關帳
                        if (dgViewMF.SelectedRows.Count > 0)
                        {
                            ...
                            for (int iRow = 0; iRow < dgViewMF.SelectedRows.Count; iRow++)
                            {
                                ...
                                {
                                    case "Pat":
                                        Public.CPatentPayment pat = new LawtechPTSystemByFirm.Public.CPatentPayment();
                                    ...
                                    case "Tm":
                                        ...
                                        break;
                                    case "CO":
                                        Public.CTrademarkControversyPayment CO = new LawtechPTSystemByFirm.Public.CTrademarkControversyPayment("ControversyPaymentID=" + Feekey.ToString());
                            ...
                            if (dgViewMF.CurrentRow != null)
                            {
                                ...
                                switch (dgViewMF.CurrentRow.Cells["CaseType"].Value.ToString())
                                {
                                    case "Pat":
                                        ...
                                        break;
                                    case "Tm":
                                        Public.CTrademarkPayment TM = new LawtechPTSystemByFirm.Public.CTrademarkPayment();
                            ...
                            for (int iRow = 0; iRow < dgViewMF.SelectedRows.Count; iRow++)
                            {
                                ...
                                switch (sCaseType)
                                {
                                    ...
                                    case "Tm":
                                        ...
                                        break;
                                    case "CO":
                                        Public.CTrademarkControversyPayment CO = new LawtechPTSystemByFirm.Public.CTrademarkControversyPayment("ControversyPaymentID=" + PaymentID.ToString());
                            ...
                            if (dgViewMF.CurrentRow != null)
                            {
                                ...
                                switch (sCaseType)
                                {
                                    ...
                                    case "Tm":
                                        ...
                                        break;
                                    case "CO":
                                        Public.CTrademarkControversyFee CO = new LawtechPTSystemByFirm.Public.CTrademarkControversyFee("ControversyPaymentID=" + Feekey.ToString());
                                        CO.SetCurrent(Feekey);
                                        CO.IsClosing = false;
                                        CO.CloseDate = new DateTime(1900, 1, 1);
                                        CO.Updata(Feekey);
