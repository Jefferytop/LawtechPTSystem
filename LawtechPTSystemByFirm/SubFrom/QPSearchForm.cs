        ...
        private void linkLabel_SignDocument_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            switch (link.Name)
            {
                case "linkLabel_SignDocument":
                    pop = new LawtechPTSystemByFirm.US.PopMemo(txtSignDocument, true, link.Text);
                    break;
                case "linkLabel_Remark":
                    pop = new LawtechPTSystemByFirm.US.PopMemo(txtRemark, true, link.Text);
                    break;
                case "linkLabel_MeRemark":
                    pop = new LawtechPTSystemByFirm.US.PopMemo(txtMeRemark, true, link.Text);
                    break;
                default:
                    pop = new LawtechPTSystemByFirm.US.PopMemo(txtSignDocument, true, link.Text);
                    break;
