    ...
    public partial class AccountingCombin : Form
    {
        ...
        private void dgViewMF_SelectionChanged(object sender, EventArgs e)
        {
            if (dgViewMF.CurrentRow != null)
            {
                ...
                if (radioButton_Patent.Checked)//專利
                {
                    QS_DataSetTableAdapters.PatentFeeTTableAdapter patFee = new LawtechPTSystemByFirm.QS_DataSetTableAdapters.PatentFeeTTableAdapter();
                    ...
                    QS_DataSetTableAdapters.PatentPaymentTTableAdapter patPayment = new LawtechPTSystemByFirm.QS_DataSetTableAdapters.PatentPaymentTTableAdapter();
                ...
                else//商標
                {
                    if (dgViewMF.CurrentRow.Cells["CaseTypeMode"].Value.ToString() == "Tm")//一般案
                    {
                        ...
                        DataSet_TMTableAdapters.TrademarkPaymentTTableAdapter TmPayment = new LawtechPTSystemByFirm.DataSet_TMTableAdapters.TrademarkPaymentTTableAdapter();
        ...
        private void toolStripButton_CaseDetail_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    TrademarkHistoryRecord trademark = new LawtechPTSystemByFirm.SubFrom.TrademarkHistoryRecord();
                ...
                {
                    TrademarkControversyHistoryRecord trademark = new LawtechPTSystemByFirm.SubFrom.TrademarkControversyHistoryRecord();
                    trademark.TrademarkControversyID = (int)dgViewMF.CurrentRow.Cells["PatentID"].Value;
                    trademark.TabSelectedIndex = 3;
                    trademark.Show();
                }
            }
