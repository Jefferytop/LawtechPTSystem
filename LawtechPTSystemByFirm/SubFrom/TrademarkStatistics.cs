...
namespace LawtechPTSystemByFirm.SubFrom
{
    public partial class TrademarkStatistics : Form
    {
        ...
        private void but_Search_Click(object sender, EventArgs e)
        {
            ...
            {
                strStatus = "TrademarkManagementT.Status=" + comboBox_Status.SelectedValue.ToString();
            }
            ...
            {
                strStyle = "TrademarkManagementT.StyleName='" + comboBox_Style.Text.ToString() + "' ";
            }
            ...
            {
                strTMTypeName = "TrademarkManagementT.TMTypeName='" + comboBox_Type.Text.ToString() + "' ";
            }
        ...
        private void but_Statistic_Click(object sender, EventArgs e)
        {
            ...
            {
                TrademarkAnalysis Analysis = new LawtechPTSystemByFirm.SubFrom.TrademarkAnalysis();
        ...
        private void but_FeeStatistics_Click(object sender, EventArgs e)
        {
            if (trademarkManagementTDataGridView.Rows.Count > 0)
            {
                TrademarkFeeStatistics FeeAnalysis = new LawtechPTSystemByFirm.SubFrom.TrademarkFeeStatistics();
