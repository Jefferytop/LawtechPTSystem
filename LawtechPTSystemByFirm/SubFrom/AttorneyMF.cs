    ...
    {  
        ...
        private void AttorneyT_ColumnChanged(object sender, DataColumnChangeEventArgs e)
        {
            if (e.Row.RowState == DataRowState.Unchanged)
            {
                ...
                CA_CAttorney.LastModifyWorker = Properties.Settings.Default.WorkerKEY;
                CA_CAttorney.Update();
        ...
        private void AttorneyT_RowDeleting(object sender, DataRowChangeEventArgs e)
        {
            ...
            //string[] str = CA_CAttorney.GetInsertString(iKey);
            //log.TableName = str[2];
            ...
            log.DelTitle = string.Format("刪除事務所資料【{0}】", CA_CAttorney.AttorneyFirm);
            log.Create();
        ...
        private void AttLiaisonerT_RowDeleting(object sender, DataRowChangeEventArgs e)
        {
            ...
            log.DelTime = DateTime.Now;
            log.DelWorkerKey = Properties.Settings.Default.WorkerKEY;
            //string[] str = CA_CAttLiaisoner.GetInsertString(iKey);
            //log.TableName = str[2];
            //log.DelContent_InsertColumn = str[0];
            //log.DelContent_InsertSQL = str[1];
            log.DelContent = string.Format("聯絡人姓名:{0}\r\n分機:{1}\r\n行動電話:{2}\r\n電子信箱:{3}\r\n性別:{4}", CA_CAttLiaisoner.Liaisoner, CA_CAttLiaisoner.Ext, CA_CAttLiaisoner.Moblephone, CA_CAttLiaisoner.email, CA_CAttLiaisoner.Gender);
            log.DelTitle = string.Format("刪除事務所聯絡人資料【{0}】", CA_CAttLiaisoner.Liaisoner);
            log.Create();
        ...
        private void contextMenuStrip1_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            ...
            switch (e.ClickedItem.Name)
            {
                ...
                case "AddAttroneyMenuItem":
                    ...
                    AddFrom.AddAttorney add = new LawtechPTSystemByFirm.AddFrom.AddAttorney();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            attorneyTBindingSource1.Filter = strSQLWhere;  
        }
        #endregion
        ...
        private void contextMenuStrip2_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            switch (e.ClickedItem.Name)
            {
                ...
                case "AddLiaisonerMenuItem":
                    ...
                    if (GridView_Attorney.CurrentRow != null)
                    {
                        AddFrom.AddAttLiaisoner add = new LawtechPTSystemByFirm.AddFrom.AddAttLiaisoner();
        ...
        private void contextMenuStrip_Record_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            ...
            switch (e.ClickedItem.Name)
            {
                ...
                case "ToolStripMenuItem_AddRecord":
                    if (GridView_Attorney.CurrentRow != null)
                    {
                        AddFrom.AddAttorneyRecord add = new LawtechPTSystemByFirm.AddFrom.AddAttorneyRecord();
                ...
                case "ToolStripMenuItem_DelRecord":
                    ...
                    if (attorneyTrackingRecordTDataGridView.CurrentRow != null)
                    {
                        if (MessageBox.Show("是否確定刪除此筆往來記錄 ", "確認視窗", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK)
                        {
                            ...
                            CA_Del.AttorneyTrackingRecordKey = iKey;
                            CA_Del.Delete();
