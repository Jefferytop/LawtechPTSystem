...
namespace LawtechPTSystemByFirm.SubFrom
{
    ...
    public partial class ClientFeeMF : Form
    {
        ...
        void detailDT_ColumnChanged(object sender, DataColumnChangeEventArgs e)
        {
            ...
            e.Row["LastModifyWorker"] = cf.LastModifyWorker;
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView1.RowCount; i++)
            {
                ...
                {  
                    ...
                    string SQLCommand = string.Format("select * from ClientFeeT where ApplicantKey ={0} And Country = '{1}' And Kind = '{2}' And LargeEntity = {3} and ApplicantMode={4}", appKey, countryKey, kindKey, largeEntity, ApplicantMode);   
                    DataTable dtTemp = new DataTable();
                    dbhelper.QueryToDataTableByDataAdapter(SQLCommand, ref dtTemp);
                    dbhelper.SqlBulkCopyWriteToServer(dtTemp, DBAccess.ConnectionList["DataBaseConnectionString"], "ClientFeeT_Temp");
                    c++;
                }
        ...
        private void comboBox_Mode_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (comboBox_Mode.SelectedIndex == 0)
            {
                ...
                cbbCompany.DisplayMember = "ApplicantName";
