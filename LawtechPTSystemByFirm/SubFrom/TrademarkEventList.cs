    ...
    public partial class TrademarkEventList : Form
    {
        ...
        private void button_Search_Click(object sender, EventArgs e)
        {
            ...
            if (ds.Tables.Count == 2 && ds.Tables[1].Rows.Count == 1)
            {
                ...
                bool isOtherTotalFeeT = decimal.TryParse(ds.Tables[1].Rows[0]["FeeOtherTotalFee"].ToString(), out deOtherTotalFeeT);
                toolStripLabel_OtherTotalFeeT.Text = deOtherTotalFeeT.ToString("#,##0.##");
                ...
                bool isOAttorneyGovFee = decimal.TryParse(ds.Tables[1].Rows[0]["PaymentSUM_Totall"].ToString(), out deOAttorneyGovFee);
                toolStripLabel_PaymentSUM_Totall.Text = deOAttorneyGovFee.ToString("#,##0.##");
                ...
                toolStripLabel_PaymentSUM_ActuallyPay.Text = deOAttorneyGovFee.ToString("#,##0.##");
            }
        ...
        public DataSet GetTrademarkEventList()
        {
           ...
           SELECT   sum(FeeOtherTotalFee) as FeeOtherTotalFee,sum(FeeSUM_TotalNT) as FeeSUM_TotalNT,sum(FeeSUM_PracticalityPay) as FeeSUM_PracticalityPay,sum(PaymentSUM_Totall) as  PaymentSUM_Totall,sum(PaymentSUM_ActuallyPay) as  PaymentSUM_ActuallyPay from  V_TrademarkEventList with(nolock) {0} ", strSQLWhere.Trim() != "" ? " where " + strSQLWhere : "");
        ...
        private void contextMenuStrip1_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            ...
            switch (e.ClickedItem.Name)
            {
                case "ToolStripMenuItem_PatentView":
                    ...
                    {
                        TrademarkHistoryRecord patent = new LawtechPTSystemByFirm.SubFrom.TrademarkHistoryRecord();
