...
namespace LawtechPTSystemByFirm.SubFrom
{
    ...
    public partial class AccountingFeeList : Form
    {
        ...
        private void but_Search_Click(object sender, EventArgs e)
        {
            ...
            {
                strFilter = " PayDate is null and PPP is not null and IsClosing<>1";
            }
            else//已完成:
            {
            ...
            if (dgViewMF.CurrentRow != null)
            {
                ...
                switch (e.ClickedItem.Name)
                {
                    case "ToolStripMenuItem_FinishFee":
                        ...
                        US.FeeFinish fee = new LawtechPTSystemByFirm.US.FeeFinish();
                    ...
                    case "ToolStripMenuItem_SingOff":
                        ...
                        if (sCaseType == "Pat")
                        {
                            EditForm.EditPatentFee patentfee = new LawtechPTSystemByFirm.EditForm.EditPatentFee();
                            patentfee.property_FeeKEY = (int)dgViewMF.CurrentRow.Cells["FeeKEY"].Value;
                            patentfee.ShowDialog();
                        }
                        else if (sCaseType == "Tm")
                        {
                            EditForm.EditTrademarkFee trademarkfee = new LawtechPTSystemByFirm.EditForm.EditTrademarkFee();
                            trademarkfee.property_FeeKEY = (int)dgViewMF.CurrentRow.Cells["FeeKEY"].Value;
                            trademarkfee.ShowDialog();
                        }
                        else if (sCaseType == "CO")
                        {
                            EditForm.EditTrademarkControversyFee trademarkfee = new LawtechPTSystemByFirm.EditForm.EditTrademarkControversyFee();
                            trademarkfee.property_FeeKEY = (int)dgViewMF.CurrentRow.Cells["FeeKEY"].Value;
                            trademarkfee.ShowDialog();
                        }
                        break;
                    ...
                    case "toolStripMenuItem_PayDateFinish"://填收款日
                        ...
                        {
                            US.FeeFinishDate FeeDate=new LawtechPTSystemByFirm.US.FeeFinishDate();
                            ...
                            if (FeeDate.ShowDialog() == DialogResult.OK)
                            {
                                ...
                                for (int iRow = 0; iRow < dgViewMF.SelectedRows.Count; iRow++)
                                {
                                    ...
                                    {
                                        case "Pat":
                                            Public.CPatentFee pat = new LawtechPTSystemByFirm.Public.CPatentFee();
                                            ...
                                            break;
                                        case "Tm":
                                            Public.CTrademarkFee TM = new LawtechPTSystemByFirm.Public.CTrademarkFee();
                                            ...
                                            break;
                                        case "CO":
                                            Public.CTrademarkControversyFee CO = new LawtechPTSystemByFirm.Public.CTrademarkControversyFee("ControversyFeeKEY=" + Feekey.ToString());
                            ...
                            if (dgViewMF.CurrentRow!=null)
                            {
                                ...
                                switch (sCaseType)
                                {
                                    case "Pat":
                                        ...
                                        Public.CPatentFee.ReadOne(Feekey, ref pat);
                                        pat.IsClosing = false;
                                        pat.CloseDate = new DateTime(1900, 1, 1);
                                        pat.Update();
