...
namespace LawtechPTSystem.US
{
    public partial class PaymentFinish : Form
    {
        ...
        private void PaymentFinish_Load(object sender, EventArgs e)
        {
            ...
            switch (iTypeKind)
            {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    Public.CTrademarkControversyPayment TmCoPay = new Public.CTrademarkControversyPayment("ControversyPaymentID=" + iPaymentID.ToString());
        ...
        private void maskedTextBox_IReceiptDate_Leave(object sender, EventArgs e)
        {
