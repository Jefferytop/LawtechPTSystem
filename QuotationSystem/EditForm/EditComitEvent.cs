...
namespace LawtechPTSystem.EditForm
{
    public partial class EditComitEvent : Form
    {
        ...
        /// 記錄案件階段、描述是否有被異動
        /// </summary>
        public bool PatentChange { get; private set; }

        /// <summary>
        /// 0:僅僅「處理結果」、「送件日期」、「開工日期」 欄位可編輯 ; 9:完整編輯事件記錄
        /// </summary>
        public string HomePageEvent
        {
            set {
                if (value == "0")
                {
                    ...
                    txt_EventContent.Enabled = false;
                    txtRemark.Enabled = false;
                    maskedTextBox_CreateDate.Enabled = false;
                    maskedTextBox_OfficerDate.Enabled = false;
                    maskedTextBox_EventContent.Enabled = false;
                    maskedTextBox_OfficeDueDate.Enabled = false;
                    maskedTextBox_DueDate.Enabled = false;
                    maskedTextBox_FinishDate.Enabled = false;
                    Combo_EClientWorker.Enabled = false;
                    Combo_EAttorney.Enabled = false;
                    Combo_EAttorneyTransactor.Enabled = false;
                    //maskedTextBox_StartDate.Enabled = false;
                    //maskedTextBox_ComitDate.Enabled = false;
                }
            }
        }
        ...
        #region 取消按鈕 private void but_Cancel_Click(object sender, EventArgs e)
        /// <summary>
        /// 取消按鈕
        /// </summary>
        ...
        private void but_OK_Click(object sender, EventArgs e)
        {
            ...
            Public.CPatComitEvent edit = new Public.CPatComitEvent();
        ...
        #region 案件階段  private void comboBox_Statue_SelectedIndexChanged(object sender, EventArgs e)
        /// <summary>
        /// 案件階段
        /// </summary>
        /// <param name="sender"></param>
        ...
        #region 案件階段描述   private void txt_StatusExplain_TextChanged(object sender, EventArgs e)
        /// <summary>
        /// 案件階段描述
        /// </summary>
        /// <param name="sender"></param>
