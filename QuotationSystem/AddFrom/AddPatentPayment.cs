        ...
        private void but_OK_Click(object sender, EventArgs e)
        {
            if (txt_FeeSubject.Text != "")
            {
                ...
                if (iTypeFrom != -1)
                {
                    ...
                    {
                        case 1: //事件記錄轉付款
                            Public.CPatComitEventToPayment comitFee = new Public.CPatComitEventToPayment();
                        ...
                        case 2://來函
                            Public.CPatNotifyEventToPayment NotifyFee = new Public.CPatNotifyEventToPayment("1=0");
