...
namespace LawtechPTSystem
{
    ...
    public class Worker_Model : SysBaseModel
    {
        ...
        /// <summary>
        /// 開始功能表單時的初始狀態 Normal:一般 ; Max:最大化
        /// </summary>
        [TableColumnSetting("WindowStatus", DataLength = 100)]
        ...
        private bool? m_IsMdiParent;
        /// <summary>
        ///  是否使用MDI子表單  true:使用 ; false:不使用
        /// </summary>
        [TableColumnSetting("IsMdiParent", DbType = SqlDataType.Bit, DataLength = 1)]
        public bool? IsMdiParent
        {
            get
            {
                return m_IsMdiParent;
            }
            set
            {
                m_IsMdiParent = value;
