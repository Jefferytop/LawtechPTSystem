...
{
    public partial class PatentPerformanceList : Form
    {
        BindingSource bSource_Control;

        UserPermissionForm myPermission;
        private const string ProgramSymbol = "PatentPerformanceList";
        private const string SourceTableName = "V_PatentPerformanceBonus";

        public PatentPerformanceList()
        {
            InitializeComponent();
        ...
        #region private void PatentPerformanceList_Load(object sender, EventArgs e)
        /// <summary>
        /// 
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void PatentPerformanceList_Load(object sender, EventArgs e)
        {
            Public.PublicForm Forms = new Public.PublicForm();
            Forms.PatentPerformanceList = this;
            ...
            {
                Public.CPatentPublicFunction.GetPatentPerformanceBonus("1=0", ref dt_PatentPerformanceBonus);
            }
        ...
        #region private void PatentPerformanceList_FormClosed(object sender, FormClosedEventArgs e)
        /// <summary>
        /// 
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void PatentPerformanceList_FormClosed(object sender, FormClosedEventArgs e)
        {
            Public.PublicForm Forms = new Public.PublicForm();
            Forms.PatentPerformanceList = null;
        } 
        #endregion

        #region private void butQuery_Click(object sender, EventArgs e)
        /// <summary>
        /// 
        /// </summary>
        /// <param name="sender"></param>
        ...
        private void butQuery_Click(object sender, EventArgs e)
        {
            ...
            Public.CPatentPublicFunction.GetPatentPerformanceBonus(strSQL, ref dt_PatentPerformanceBonus);
        ...
        #region 案件完整歷程  private void toolStripButton__CompleteHistory_Click(object sender, EventArgs e)
        /// <summary>
        /// 案件完整歷程
        /// </summary>
        /// <param name="sender"></param>
        ...
        {
            if (dgViewMF.CurrentRow != null && dgViewMF.SelectedRows.Count > 0)
            {
        ...
        #region 申請案相關文件 private void toolStripLabel_UpdateFileList_Click(object sender, EventArgs e)
        /// <summary>
        /// 申請案相關文件
        /// </summary>
        /// <param name="sender"></param>
        ...
        private void dgViewMF_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.ColumnIndex != -1 && e.RowIndex != -1)
            {
                ...
                {
                    ViewFrom.PatentEventByUser patent = new ViewFrom.PatentEventByUser();
                    patent.property_PatentID = (int)dgViewMF.CurrentRow.Cells["PatentID"].Value;
                    ...
                    patent.Text = dgViewMF.CurrentRow.Cells["PatentNo"].Value.ToString() + "--" + dgViewMF.CurrentRow.Cells["EmployeeName"].Value.ToString()+" 事件記錄";
                    patent.Show();
                }
                else if (dgViewMF.Columns[e.ColumnIndex].Name == "FeeSUM")
                {
                    ViewFrom.PatentFeeByUser patent = new ViewFrom.PatentFeeByUser();
                    patent.property_PatentID = (int)dgViewMF.CurrentRow.Cells["PatentID"].Value;
                    patent.property_UserKey = dgViewMF.CurrentRow.Cells["WorkerKey"].Value.ToString() == "" ? -1 : (int)dgViewMF.CurrentRow.Cells["WorkerKey"].Value;
                    patent.Text = dgViewMF.CurrentRow.Cells["PatentNo"].Value.ToString() + "--" + dgViewMF.CurrentRow.Cells["EmployeeName"].Value.ToString() + " 請款記錄";
                    patent.Show();
                }
                else if (dgViewMF.Columns[e.ColumnIndex].Name == "PaySUM")
                {
                    ViewFrom.PatentPaymentByUser patent = new ViewFrom.PatentPaymentByUser();
                    patent.property_PatentID = (int)dgViewMF.CurrentRow.Cells["PatentID"].Value;
                    patent.property_UserKey = dgViewMF.CurrentRow.Cells["WorkerKey"].Value.ToString() == "" ? -1 : (int)dgViewMF.CurrentRow.Cells["WorkerKey"].Value;
                    patent.Text = dgViewMF.CurrentRow.Cells["PatentNo"].Value.ToString() + "--" + dgViewMF.CurrentRow.Cells["EmployeeName"].Value.ToString() + " 付款記錄";
                    patent.Show();
                }
            }
        } 
