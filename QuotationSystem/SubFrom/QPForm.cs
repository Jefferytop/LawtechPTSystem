        ...
        private void contextMenuStrip1_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            ...
            switch (e.ClickedItem.Name)
            {
                ...
                case "ToolStripMenuItem_Add":
                    ...
                    {
                        AddFrom.QPForm_New qrfrom = new LawtechPTSystem.AddFrom.QPForm_New();
                ...
                case "ToolStripMenuItem_Del":
                    if (dataGridView1.CurrentRow != null)
                    {
                        ...
                        {
                            int iKey = (int)dataGridView1.CurrentRow.Cells["FeeSN"].Value;
                            Public.CnTriff del = new CnTriff();
                            Public.CnTriff.ReadOne(iKey, ref del);
                            ...
                            log.DelContent = string.Format("作業程序: {0}", del.ProcedureName);
                            log.DelTitle = string.Format("刪除「{0}」資料【{1}】", this.Text, del.ProcedureName);
                            log.Create();
