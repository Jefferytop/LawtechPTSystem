        ...
        private void contextMenuStrip1_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            ...
            switch (e.ClickedItem.Name)
            {
                ...
                case "toolStripMenuItem_Add":
                    AddFrom.AddOfficeProperty add = new LawtechPTSystem.AddFrom.AddOfficeProperty();
                    add.ShowDialog();
                ...
                case "toolStripMenuItem_Edit":
                    ...
                    {
                        EditForm.EditOfficeProperty edit = new LawtechPTSystem.EditForm.EditOfficeProperty();
                ...
                case "toolStripMenuItem_Copy":
                    if (dataGridView1.CurrentRow != null)
                    {
                        CopyForm.CopyOfficeProperty copy = new LawtechPTSystem.CopyForm.CopyOfficeProperty();
