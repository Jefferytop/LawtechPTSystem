        ...
        private void PATControlEventWorkList_Load(object sender, EventArgs e)
        {
            try
            {
                if (TypeMode == 1)
                {
                    ...
                    this.Text += "--專利 PE" + EventID.ToString("#00");
                }
                else
                {
                    dataGridView_WorkList.Tag = "TrademarkControlEventList_Item";
                    this.Text += "--商標 TE" + EventID.ToString("#00");
                }
            ...
            if (TypeMode == 1)
            {
                ...
                switch (e.ClickedItem.Name)
                {
                    ...
                    case "ToolStripMenuItem_Add":
                        ...
                        AddFrom.AddPatentWorkEvent Add = new LawtechPTSystem.AddFrom.AddPatentWorkEvent();
                        Add.EventID = EventID;
                    ...
                    case "toolStripButton_WorkListEdit":
                        if (dataGridView_WorkList.CurrentRow != null)
                        {
                            EditForm.EditPatentWorkEvent workevent = new LawtechPTSystem.EditForm.EditPatentWorkEvent();
            ...
            else if (TypeMode == 2)
            {
                ...
                switch (e.ClickedItem.Name)
                {
                    ...
                    case "ToolStripMenuItem_Add":
                        ...
                        AddFrom.AddTrademarkWorkEvent Add = new LawtechPTSystem.AddFrom.AddTrademarkWorkEvent();
                        Add.EventID = EventID;
                        Add.EventType = EventType;
                    ...
                    case "toolStripButton_WorkListEdit":
                        if (dataGridView_WorkList.CurrentRow != null)
                        {
                            EditForm.EditTrademarkWorkEvent workevent = new LawtechPTSystem.EditForm.EditTrademarkWorkEvent();
                            workevent.EventID = EventID;
                            workevent.EventType = EventType;
                            workevent.WorkReportID = (int)dataGridView_WorkList.CurrentRow.Cells["WorkReportID"].Value;
                            workevent.ShowDialog();
