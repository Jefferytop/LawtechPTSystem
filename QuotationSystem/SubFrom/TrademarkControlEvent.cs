...
namespace LawtechPTSystem.SubFrom
{
    ...
    public partial class TrademarkControlEvent : Form
    {
        ...
        private void butQuery_Click(object sender, EventArgs e)
        {
            ...
            #region strWhere1
            string selectValue=((Public.CCombox)(searchMainByTM1.comboBox1.SelectedItem)).ValueString;
            ...
            #region strWhere2
            string selectValue2 = ((Public.CCombox)(searchMainByTM2.comboBox1.SelectedItem)).ValueString;
                    ...
                    if (dgViewMF.CurrentRow.Cells["EventKind"].Value.ToString() != "" && (int)dgViewMF.CurrentRow.Cells["EventKind"].Value == 3)
                    {
                        if (dgViewMF.CurrentRow.Cells["TableTypeName"].Value.ToString() == "TM")
                        {
                            ...
                            if (iLocker == -1 || iLocker == iWorkerID)
                            {
                                ...
                                if (edit.ShowDialog() == DialogResult.OK)
                                {
                                    Public.CTrademarkPayment TmPay1 = new Public.CTrademarkPayment();
