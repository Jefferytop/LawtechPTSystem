...
{
    #region CPatentPayment=================
    /// <summary>
    /// 
    /// </summary>
    [TableMapping("PatentPaymentT")]
    public class CPatentPayment : SysBaseModel
    {
        ...
        public object CheckValueExist(string ColumnName, object Value, ref bool IsExist, bool IsCreateMode = true)
        {
            ...
            List<CPatentPayment> list = new List<CPatentPayment>();
            ...
            if (IsCreateMode)
            {
                retObj = orm.ReadListToObjs<CPatentPayment>(ColumnName + "=@" + ColumnName, ref list, ParList);
            }
            else
            {
                retObj = orm.ReadListToObjs<CPatentPayment>(ColumnName + "=@" + ColumnName + " and PaymentID<>" + this.PaymentID.ToString(), ref list, ParList);
            }
        ...
        #region 取得一筆資料  ReadOne(ref CPatentPayment Item, string strCusTableName = ")
        /// <summary>
        /// 取得一筆PatentPaymentT資料
        /// </summary>          
        /// <param name="item"></param>   
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        /// <returns>0:成功 ; string:失敗</returns>       
        public static object ReadOne(ref CPatentPayment Item, string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        /// <returns>0:成功 ; string:失敗</returns>       
        public static object ReadOne(int iPKey, ref CPatentPayment item, string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
        ...
        #region 取得一筆PatentPaymentT資料 ReadOne(string strSqlWhere, System.Data.SqlClient.SqlParameter[] MySqlParameterList=null, string strCusTableName = "")
        /// <summary>
        /// 取得一筆PatentPaymentT資料;如果有多筆符合條件，則只回傳null
        /// </summary>
        /// <param name="strSqlWhere">查詢條件(不用加「where」關鍵字, 可加Sql參數,例如: account=@account)</param>
        /// <param name="MySqlParameterList">Sql參數</param>
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        /// <returns>0:成功 ; string:失敗</returns>
        public static object ReadOne(string strSqlWhere, ref CPatentPayment item, System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
            List<CPatentPayment> itemlist = new List<CPatentPayment>();
        ...
        #region 取得多筆CPatentPayment資料 ReadList
        /// <summary>
        /// 取得多筆 PatentPaymentT資料 
        /// </summary>
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>      
        /// <returns></returns>
        public static object ReadList(ref List<CPatentPayment> Items, string strSqlWhere = "", System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strOrderBy = "", string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();

            object retObj = orm.ReadListToObjs<CPatentPayment>(strSqlWhere, ref Items, sqlParameterList: MySqlParameterList, OrderBy: strOrderBy, CusTableName: strCusTableName);
        ...
        #region 取得多筆 PatentPaymentT資料 , 指定頁數和頁碼 ReadList
        /// <summary>
        /// 取得多筆 PatentPaymentT資料 , 指定頁數和頁碼
        /// </summary>
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>       
        /// <returns></returns>
        public static object ReadList(int PageSize, int PageIndex, ref List<CPatentPayment> Items, string strSqlWhere = "", System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strOrderBy = "", string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();

            object retObj = orm.ReadListToObjs<CPatentPayment>(PageSize, PageIndex, strSqlWhere, ref Items, sqlParameterList: MySqlParameterList, OrderBy: strOrderBy, CusTableName: strCusTableName);
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.InsertByObj<CPatentPayment>(this, strCusTableName);
            return retObj;
        }
        #endregion
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.UpdateObj<CPatentPayment>(this, strCusTableName);
            return retObj;
        }
        #endregion
        ...
        #region 刪除項目PatentPaymentT Delete()
        /// <summary>
        /// 刪除項目PatentPaymentT
        /// </summary>  
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.DeleteObj<CPatentPayment>(this, strCusTableName);
            return retObj;
        }
        #endregion

        #region 刪除項目PatentPaymentT Delete(int iPKey)
        /// <summary>
        /// 刪除項目PatentPaymentT , 指定某一筆主鍵刪除(單筆)
        /// </summary>
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.DeleteObj<CPatentPayment>(iPKey, strCusTableName);
            return retObj;
        }
        #endregion

        #region 刪除項目PatentPaymentT Delete(string strSqlWhere)
        /// <summary>
        /// 刪除項目PatentPaymentT ,符合條件刪除(多筆)
        /// </summary>
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.DeleteObj<CPatentPayment>(strSqlWhere, strCusTableName);
            return retObj;
        }
        #endregion
