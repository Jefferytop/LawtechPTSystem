...
namespace LawtechPTSystem.Public
{
    ...
    public class CSystemLogT : SysBaseModel
    {
        ...
        private string m_DelWorker;
        /// <summary>
        /// 
        /// </summary>
        [TableColumnSetting("DelWorker", DataLength = 100)]
        ...
        public object CheckValueExist(string ColumnName, object Value, ref bool IsExist, bool IsCreateMode = true)
        {
            ...
            List<CSystemLogT> list = new List<CSystemLogT>();
            ...
            if (IsCreateMode)
            {
                retObj = orm.ReadListToObjs<CSystemLogT>(ColumnName + "=@" + ColumnName, ref list, ParList);
            }
            else
            {
                retObj = orm.ReadListToObjs<CSystemLogT>(ColumnName + "=@" + ColumnName + " and SysLogID<>" + this.SysLogID.ToString(), ref list, ParList);
            }
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.ReadCountRows<CSystemLogT>(ref iCountRows, strSqlWhere, sqlParameterList: sqlParameterList, CusTableName: strCusTableName);
            return retObj;
        }
        #endregion

        #region 取得一筆資料  ReadOne(ref CSystemLogT Item, string strCusTableName = ")
        /// <summary>
        /// 取得一筆SystemLogT資料
        /// </summary>          
        ...
        /// <returns>0:成功 ; string:失敗</returns>       
        public static object ReadOne(ref CSystemLogT Item, string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
        ...
        #region 取得一筆資料 ReadOne(int iPKey, ref CSystemLogT item, string strCusTableName = "")
        /// <summary>
        /// 取得一筆SystemLogT資料
        /// </summary>
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        /// <returns>0:成功 ; string:失敗</returns>       
        public static object ReadOne(int iPKey, ref CSystemLogT item, string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        /// <returns>0:成功 ; string:失敗</returns>
        public static object ReadOne(string strSqlWhere, ref CSystemLogT item, System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
            List<CSystemLogT> itemlist = new List<CSystemLogT>();
        ...
        #region 取得多筆CSystemLogT資料 ReadList 
        /// <summary>
        /// 取得多筆 SystemLogT資料，符合的全部撈出並轉成物件
        /// </summary>
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>      
        /// <returns></returns>
        public static object ReadList(ref List<CSystemLogT> Items, string strSqlWhere = "", System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strOrderBy = "", string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();

            object retObj = orm.ReadListToObjs<CSystemLogT>(strSqlWhere, ref Items, sqlParameterList: MySqlParameterList, OrderBy: strOrderBy, CusTableName: strCusTableName);
        ...
        #region 取得多筆CSystemLogT資料 ReadList DataTable
        /// <summary>
        /// 取得多筆 SystemLogT DataTable資料
        /// </summary>
        /// <param name="Items"></param>
        /// <param name="strSqlWhere">SQL條件式 (不用加「where」關鑵字,可加Sql參數,例如: account=@account)</param>
        /// <param name="MySqlParameterList">Sql參數</param>
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>       
        /// <returns></returns>
        public static object ReadList(int PageSize, int PageIndex, ref List<CSystemLogT> Items, string strSqlWhere = "", System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strOrderBy = "", string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
            int iTotalCountRows = 0;
            object retObj = orm.ReadListToObjsByFetch<CSystemLogT>(PageSize, PageIndex, strSqlWhere, ref Items, ref iTotalCountRows, sqlParameterList: MySqlParameterList, OrderBy: strOrderBy, CusTableName: strCusTableName);

            return retObj;
        }
        #endregion

        #region 取得多筆 SystemLogT資料 , 指定頁數和頁碼 ReadList,回傳查詢的總筆數
        /// <summary>
        /// 取得多筆 SystemLogT資料 , 指定頁數和頁碼,回傳查詢的總筆數
        /// </summary>
        /// <param name="PageSize">一頁的筆數</param>
        /// <param name="PageIndex">第 n 頁;從 0 起算，當值小於0時，預設帶0 (0即表示第一頁)</param>
        /// <param name="Items"></param>
        ...
        /// <returns></returns>
        public static object ReadList(int PageSize, int PageIndex, ref List<CSystemLogT> Items, ref int iTotalRowCount, string strSqlWhere = "", System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strOrderBy = "", string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();

            object retObj = orm.ReadListToObjsByFetch<CSystemLogT>(PageSize, PageIndex, strSqlWhere, ref Items, ref iTotalRowCount, sqlParameterList: MySqlParameterList, OrderBy: strOrderBy, CusTableName: strCusTableName);

            return retObj;
        }
        #endregion

        #region 取得多筆 SystemLogT DataTable資料 , 指定頁數和頁碼 ReadList,回傳查詢的總筆數
        /// <summary>
        /// 取得多筆 SystemLogT DataTable 資料 , 指定頁數和頁碼,回傳查詢的總筆數
        /// </summary>
        /// <param name="PageSize">一頁的筆數</param>
        /// <param name="PageIndex">第 n 頁;從 0 起算，當值小於0時，預設帶0 (0即表示第一頁)</param>
        /// <param name="Items"></param>
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.InsertByObj<CSystemLogT>(this, strCusTableName);
            return retObj;
        }
        #endregion
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.UpdateObj<CSystemLogT>(this, strCusTableName);
            return retObj;
        }
        #endregion
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.DeleteObj<CSystemLogT>(this, strCusTableName);
            return retObj;
        }
        #endregion
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.DeleteObj<CSystemLogT>(iPKey, strCusTableName);
            return retObj;
        }
        #endregion      
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.DeleteObj<CSystemLogT>(strSqlWhere, strCusTableName);
            return retObj;
        }
        #endregion
