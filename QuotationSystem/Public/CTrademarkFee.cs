...
{
    #region CTrademarkFee=================
    /// <summary>
    /// 
    /// </summary>
    [TableMapping("TrademarkFeeT")]
    public class CTrademarkFee : SysBaseModel
    {
        ...
        /// 
        /// </summary>
        [TableColumnSetting("TtoNT", DbType = SqlDataType.Decimal, DataLength = 5)]
        ...
        /// 
        /// </summary>
        [TableColumnSetting("CustomizeName", DataLength = 400)]
        ...
        /// 
        /// </summary>
        [TableColumnSetting("CustomizeNT", DbType = SqlDataType.Decimal, DataLength = 5)]
        ...
        public object CheckValueExist(string ColumnName, object Value, ref bool IsExist, bool IsCreateMode = true)
        {
            ...
            List<CTrademarkFee> list = new List<CTrademarkFee>();
            ...
            if (IsCreateMode)
            {
                retObj = orm.ReadListToObjs<CTrademarkFee>(ColumnName + "=@" + ColumnName, ref list, ParList);
            }
            else
            {
                retObj = orm.ReadListToObjs<CTrademarkFee>(ColumnName + "=@" + ColumnName + " and FeeKEY<>" + this.FeeKEY.ToString(), ref list, ParList);
            }
        ...
        #region 取得一筆資料  ReadOne(ref CTrademarkFee Item, string strCusTableName = ")
        /// <summary>
        /// 取得一筆TrademarkFeeT資料
        /// </summary>          
        ...
        /// <returns>0:成功 ; string:失敗</returns>       
        public static object ReadOne(ref CTrademarkFee Item, string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
        ...
        #region 取得一筆資料 ReadOne(int iPKey, ref CTrademarkFee item, string strCusTableName = "")
        /// <summary>
        /// 取得一筆TrademarkFeeT資料
        /// </summary>
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        /// <returns>0:成功 ; string:失敗</returns>       
        public static object ReadOne(int iPKey, ref CTrademarkFee item, string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
        ...
        #region 取得一筆TrademarkFeeT資料 ReadOne(string strSqlWhere, System.Data.SqlClient.SqlParameter[] MySqlParameterList=null, string strCusTableName = "")
        /// <summary>
        /// 取得一筆TrademarkFeeT資料;如果有多筆符合條件，則只回傳null
        /// </summary>
        /// <param name="strSqlWhere">查詢條件(不用加「where」關鍵字, 可加Sql參數,例如: account=@account)</param>
        /// <param name="MySqlParameterList">Sql參數</param>
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        /// <returns>0:成功 ; string:失敗</returns>
        public static object ReadOne(string strSqlWhere, ref CTrademarkFee item, System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();
            List<CTrademarkFee> itemlist = new List<CTrademarkFee>();
        ...
        #region 取得多筆CTrademarkFee資料 ReadList
        /// <summary>
        /// 取得多筆 TrademarkFeeT資料 
        /// </summary>
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>      
        /// <returns></returns>
        public static object ReadList(ref List<CTrademarkFee> Items, string strSqlWhere = "", System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strOrderBy = "", string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();

            object retObj = orm.ReadListToObjs<CTrademarkFee>(strSqlWhere, ref Items, sqlParameterList: MySqlParameterList, OrderBy: strOrderBy, CusTableName: strCusTableName);
        ...
        #region 取得多筆 TrademarkFeeT資料 , 指定頁數和頁碼 ReadList
        /// <summary>
        /// 取得多筆 TrademarkFeeT資料 , 指定頁數和頁碼
        /// </summary>
        ...
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>       
        /// <returns></returns>
        public static object ReadList(int PageSize, int PageIndex, ref List<CTrademarkFee> Items, string strSqlWhere = "", System.Data.SqlClient.SqlParameter[] MySqlParameterList = null, string strOrderBy = "", string strCusTableName = "")
        {
            ORMFactory orm = new ORMFactory();

            object retObj = orm.ReadListToObjs<CTrademarkFee>(PageSize, PageIndex, strSqlWhere, ref Items, sqlParameterList: MySqlParameterList, OrderBy: strOrderBy, CusTableName: strCusTableName);
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.InsertByObj<CTrademarkFee>(this, strCusTableName);
            return retObj;
        }
        #endregion
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.UpdateObj<CTrademarkFee>(this, strCusTableName);
            return retObj;
        }
        #endregion
        ...
        #region 刪除項目TrademarkFeeT Delete()
        /// <summary>
        /// 刪除項目TrademarkFeeT
        /// </summary>  
        /// <param name="strCusTableName">指定的資料表; 若為空則採預設的Model所綁定的資料表</param>
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.DeleteObj<CTrademarkFee>(this, strCusTableName);
            return retObj;
        }
        #endregion

        #region 刪除項目TrademarkFeeT Delete(int iPKey)
        /// <summary>
        /// 刪除項目TrademarkFeeT , 指定某一筆主鍵刪除(單筆)
        /// </summary>
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.DeleteObj<CTrademarkFee>(iPKey, strCusTableName);
            return retObj;
        }
        #endregion

        #region 刪除項目TrademarkFeeT Delete(string strSqlWhere)
        /// <summary>
        /// 刪除項目TrademarkFeeT ,符合條件刪除(多筆)
        /// </summary>
        ...
        {
            ORMFactory orm = new ORMFactory();
            object retObj = orm.DeleteObj<CTrademarkFee>(strSqlWhere, strCusTableName);
            return retObj;
        }
        #endregion
