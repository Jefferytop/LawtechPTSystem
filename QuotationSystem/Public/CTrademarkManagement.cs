...
namespace LawtechPTSystem.Public
{
    ...
    public class CTrademarkManagement : SysBaseModel
    {
        ...
        private int? m_TMStyleModelID;
        /// <summary>
        /// 彩/墨 色
        /// </summary>
        [TableColumnSetting("TMStyleModelID", DbType = SqlDataType.Int, DataLength = 4)]
        public int? TMStyleModelID
        {
            get
            {
                return m_TMStyleModelID;
            }
            set
            {
                m_TMStyleModelID = value;
            }
        }
        ...
        /// 優先權申請號
        /// </summary>
        [TableColumnSetting("EarlyPriorityNo", DataLength = 1000)]
