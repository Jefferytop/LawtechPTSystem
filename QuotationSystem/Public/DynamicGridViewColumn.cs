                ...
                foreach (var item in colums)
                {
                    switch (item.GridColumnType.Value)
                    {
                        ...
                        case 4:
                            ...
                            if (!string.IsNullOrEmpty(item.Font))
                            {
                                myFont4 = new System.Drawing.Font(item.Font, fontSize);
                            }
                            else
                            {
                                myFont4 = new System.Drawing.Font("微軟正黑體", fontSize);
                            }
                        ...
                        case 5:
                            ...
                            if (!string.IsNullOrEmpty(item.Font))
                            {
                                myFont5 = new System.Drawing.Font(item.Font, fontSize);
                            }
                            else
                            {
                                myFont5 = new System.Drawing.Font("微軟正黑體", fontSize);
                            }
                        ...
                        default:
                            ...
                            if (!string.IsNullOrEmpty(item.Font))
                            {
                                myFont1 = new System.Drawing.Font(item.Font, fontSize);
                            }
                            else
                            {
                                myFont1 = new System.Drawing.Font("微軟正黑體", fontSize);
                            }
